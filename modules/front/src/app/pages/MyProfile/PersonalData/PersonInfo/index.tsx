...
> {
          ...
          <Row type={"flex"} className={"data-form"}>
            ...
            >
              ...
              >
                <Input
                  disabled
                  value={this.person && this.person.cityOfResidence}
                />
              </Form.Item>
            </span>
          </Row>
  ...
  openRequest = () => {
    this.getPersonalDataRequest().then(value =>
      this.props.history!.push(PersonalDataRequestManagement.PATH + "/" + value)
    );
  };

  getPersonalDataRequest = (): Promise<String> => {
    return getCubaREST()!
      .searchEntities<PersonalDataRequest>(
        PersonalDataRequest.NAME,
        {
          conditions: [
            {
