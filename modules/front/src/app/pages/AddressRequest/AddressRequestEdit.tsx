...
@injectMainStore
@observer
class AddressRequestEditComponent extends AbstractBprocEdit<
  AddressRequest,
  EditorProps
> {
            ...
            <Form layout="vertical">
              ...
              >
                {this.props.form.getFieldDecorator("comment")(
                  <TextArea rows={5} disabled={isNotDraft} />
                )}
              </Form.Item>
  ...
  renderAddress = () => {
    ...
    return (
      <div>
        ...
        >
          <Input value={formatDate(this.editAddress.startDate)} disabled />
        </Form.Item>
        ...
        >
          <Input value={formatDate(this.editAddress.endDate)} disabled />
        </Form.Item>
        ...
        >
          <Input
            value={
              this.editAddress && this.editAddress.addressType
                ? this.editAddress.addressType["_instanceName"] || ""
                : ""
            }
            disabled
          />
        ...
        >
          <Input
            value={
              this.editAddress && this.editAddress.country
                ? this.editAddress.country["_instanceName"] || ""
                : ""
            }
            disabled
          />
        ...
        >
          <Input
            value={
              this.editAddress && this.editAddress.kato
                ? this.editAddress.kato["_instanceName"] || ""
                : ""
            }
            disabled
          />
        ...
        >
          <Input
            value={
              this.editAddress && this.editAddress.streetType
                ? this.editAddress.streetType["_instanceName"] || ""
                : ""
            }
            disabled
          />
        ...
        >
          <Input
            value={
              this.editAddress ? this.editAddress.addressForExpats || "" : ""
            }
            disabled
          />
        </Form.Item>
        ...
        >
          <Input
            value={
              this.editAddress ? this.editAddress.addressEnglish || "" : ""
            }
            disabled
          />
        </Form.Item>
      ...
      <div>
          ...
          getFieldDecoratorOpts={{
            ...
            getValueFromEvent: args => {
              if (this.editAddress)
                this.changedMap.set(
                  "startDate",
                  this.editAddress.startDate
                    ? !moment(this.editAddress.startDate).isSame(args, "day")
                    : !!args
                );
              return args;
            }
          ...
          getFieldDecoratorOpts={{
            ...
            getValueFromEvent: args => {
              if (this.editAddress)
                this.changedMap.set(
                  "endDate",
                  this.editAddress.endDate
                    ? !moment(this.editAddress.endDate).isSame(args, "day")
                    : !!args
                );
              return args;
            }
            ...
            rules: [
              {
                ...
                message: this.props.intl.formatMessage(
                  { id: "form.validation.required" },
                  { fieldName: messages[entityName + ".addressType"] }
                )
              }
            ],
            getValueFromEvent: args => {
              if (this.editAddress)
                this.changedMap.set(
                  "addressType",
                  args !==
                    (this.editAddress.addressType
                      ? this.editAddress.addressType.id
                      : undefined)
                );
              return args;
            }
          ...
          getFieldDecoratorOpts={{
            getValueFromEvent: args => {
              ...
              if (this.editAddress)
                this.changedMap.set(
                  "postalCode",
                  value !== this.editAddress.postalCode
                );
              return value;
            }
          }}
            ...
            rules: [
              {
                ...
                message: this.props.intl.formatMessage(
                  { id: "form.validation.required" },
                  { fieldName: messages[entityName + ".country"] }
                )
              }
            ],
            getValueFromEvent: args => {
              const country = this.countrysDc.items.find(
                value => value.id === args
              );
              ...
              if (this.editAddress)
                this.changedMap.set(
                  "country",
                  args !==
                    (this.editAddress.country
                      ? this.editAddress.country.id
                      : undefined)
                );
              return args;
            }
        ...
        >
          {this.props.form.getFieldDecorator("kato", {
            rules: [
              {
                ...
                message: this.props.intl.formatMessage(
                  { id: "form.validation.required" },
                  { fieldName: messages[entityName + ".kato"] }
                )
              }
            ],
            getValueFromEvent: args => {
              if (this.editAddress)
                this.changedMap.set(
                  "kato",
                  args !==
                    (this.editAddress.kato
                      ? this.editAddress.kato.id
                      : undefined)
                );
              return args;
            }
            ...
            <SearchSelect
              onSearch={this.onSearchKato}
              disabled={isNotDraft}
              placeholder={this.props.intl.formatMessage({ id: "search" })}
              loading={this.katosDc.status === "LOADING"}
              options={
                this.katosDc &&
                this.katosDc.items.map(d => (
                  <Select.Option key={d.id!}>{d._instanceName}</Select.Option>
                ))
              }
            />
          )}
            ...
            rules: [
              {
                ...
                message: this.props.intl.formatMessage(
                  { id: "form.validation.required" },
                  { fieldName: messages[entityName + ".streetType"] }
                )
              }
            ],
            getValueFromEvent: args => {
              if (this.editAddress)
                this.changedMap.set(
                  "streetType",
                  args !==
                    (this.editAddress.streetType
                      ? this.editAddress.streetType.id
                      : undefined)
                );
              return args;
            }
          ...
          getFieldDecoratorOpts={{
            getValueFromEvent: args => {
              ...
              if (this.editAddress)
                this.changedMap.set(
                  "streetName",
                  value !== this.editAddress.streetName
                );
              return value;
            }
          }}
          ...
          getFieldDecoratorOpts={{
            getValueFromEvent: args => {
              ...
              if (this.editAddress)
                this.changedMap.set(
                  "building",
                  value !== this.editAddress.building
                );
              return value;
            }
          }}
          ...
          getFieldDecoratorOpts={{
            getValueFromEvent: args => {
              ...
              if (this.editAddress)
                this.changedMap.set(
                  "addressForExpats",
                  value !== this.editAddress.addressForExpats
                );
              return value;
            }
          }}
          ...
          getFieldDecoratorOpts={{
            getValueFromEvent: args => {
              ...
              if (this.editAddress)
                this.changedMap.set(
                  "addressKazakh",
                  value !== this.editAddress.addressKazakh
                );
              return value;
            }
          }}
          ...
          getFieldDecoratorOpts={{
            getValueFromEvent: args => {
              ...
              if (this.editAddress)
                this.changedMap.set(
                  "addressEnglish",
                  value !== this.editAddress.addressEnglish
                );
              return value;
            }
          }}
  ...
  onReactionDisposerEffect = (item: AddressRequest | undefined) => {
    ...
    if (addressId)
      getCubaREST()!
        .loadEntity(Address.NAME, addressId, { view: "portal.my-profile" })
        ...
        .then(value => {
          ...
          if (
            ...
            this.props.form.setFieldsValue(
              this.instanceEditAddress.getFieldValues(properties)
            );
            if (
              this.instanceEditAddress.item &&
              this.instanceEditAddress.item.kato
            )
              this.katosDc.items = [
                this.instanceEditAddress.item.kato as SerializedEntity<DicKato>
              ];
          } else if (item) {
