...
@injectMainStore
@observer
class PersonEducationEditComponent extends React.Component<Props & WrappedComponentProps & RootStoreProp & RouteComponentProps<any> & MainStoreInjected> {
  ...
  componentDidMount() {
    if (this.props.entityId !== PersonEducationManagement.NEW_SUBPATH) {
...
export default injectIntl(
  ...
  })(withRouter(PersonEducationEditComponent))
);
