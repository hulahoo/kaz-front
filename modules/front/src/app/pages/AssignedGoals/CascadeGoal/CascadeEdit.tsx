...
@inject("rootStore")
@observer
class CascadeEditComponent extends React.Component<Props & WrappedComponentProps & RootStoreProp> {
  ...
  fields = ["performancePlan", "stepStageStatus", "assignedPerson", "status"];
  ...
  render() {
    if (this.updated) {
      return <Redirect to={CascadeGoalManagement.PATH}/>;
    }
      ...
      <Card className="narrow-layout">
        <Form onSubmit={this.handleSubmit} layout="vertical">
          <Field
            ...
            propertyName="performancePlan"
            form={this.props.form}
            formItemOpts={{style: {marginBottom: "12px"}}}
            optionsContainer={this.performancePlansDc}
          ...
          <Form.Item style={{textAlign: "center"}}>
            <Link to={CascadeGoalManagement.PATH}>
  ...
  componentDidMount() {
    if (this.props.entityId !== CascadeGoalManagement.NEW_SUBPATH) {
