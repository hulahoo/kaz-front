...
class DismissalIntervew extends React.Component<Props & RootStoreProp, State> {
    ...
    exitInterviewTemplateId: string = "a763751c-81c8-5c75-2044-27b041afb167";
    ...
    submitFeedback = (e: React.MouseEvent<HTMLButtonElement>) => {
        ...
        restServices.dismissalService.saveUserFeedback({ templateId: this.exitInterviewTemplateId, personGroupId: this.props.rootStore!.userInfo.personGroupId!, questionsAndAnswers: this.answeredFeedback.questionsAndAnswers })
