...
import { DicDriverCategory } from "./tsadv_DicDriverCategory";
...
export class PersonGroupExt extends PersonGroup {
  ...
  driverCategory?: DicDriverCategory | null;
...
> = V extends "_base"
  ...
  : V extends "personGroup.currentAssignment"
  ? Pick<PersonGroupExt, "id" | "person" | "list" | "currentAssignment">
