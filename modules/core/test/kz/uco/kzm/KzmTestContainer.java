...
public class KzmTestContainer extends TestContainer {

    public KzmTestContainer() {
        super();
    ...
    public static class Common extends KzmTestContainer {

        public static final KzmTestContainer.Common INSTANCE = new KzmTestContainer.Common();
